...
I use have a 4K monitor, which is great for gaming & programming, but kind of overkill for writing blog posts. I don't
...
Check out the full [vimscript code here][gist], or let me know on [twitter](https://twitter.com/naps62) if you have any thoughts on how to improve this.
